        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">Total Transaksi</p>
                <p className="text-2xl font-bold text-zinc-900 dark:text-white">{data.totalTransaksi}</p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">Total Pendapatan</p>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">Rata-rata / Transaksi</p>
              ...
              <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
                {data.transactions.map((tx) => (
                  <div key={tx.id}>
                    ...
                    >
                      <div className="bg-emerald-50 dark:bg-emerald-900/20 p-2 rounded-lg flex-shrink-0">
                    ...
                    {/* Detail Expand */}
                    {expandedId === tx.id && (
                      <div className="px-5 pb-4 bg-zinc-50 dark:bg-zinc-800/30">
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="text-xs text-zinc-400 border-b border-zinc-200 dark:border-zinc-700">
                          ...
                          <tfoot>
                            <tr className="border-t border-zinc-200 dark:border-zinc-700">
                              <td colSpan={3} className="py-2 text-right font-bold text-zinc-900 dark:text-white">
                                TOTAL
                              </td>
