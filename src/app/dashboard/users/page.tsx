...
export default function UsersPage() {
 ...
 {users.map(u => (
 <div key={u.id} className="flex items-center gap-4 px-5 py-4 hover:bg-zinc-50 transition-colors">
 ...
 <p className="font-semibold text-sm text-zinc-900 truncate">{u.name}</p>
 ...
 <h2 className="text-lg font-bold text-zinc-900 ">Tambah User Baru</h2>
